        ...
        >
            {({ isSubmitting }) => (
                <Form className="form">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque id erat sollicitudin, scelerisque neque in, gravida neque.</p>
                    ...
                    <FormGroupText label="Relationship" id="relationship" name="relationship" />
                    <FormGroupText label="Employer Phone" id="employerPhone" name="employerPhone" />
